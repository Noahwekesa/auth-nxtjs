...
export default function SignupPage() {
  ...
  // check if there are inputs ented to enable button
  useEffect(() => {
    if (
      user.email.length > 0 &&
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen ">
      ...
      {buttonDisabled ? (
        <button className="opacity-70 cursor-not-allowed text-white bg-blue-700 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-gray-500">
          Sign Up
        </button>
      ) : (
        <button
